...
export class InternalDimension extends Dimension{
	...
	public constructor(world: World, id: string, type: DimensionType, generator: TerrainGenerator){ super(world, id, type, generator); this.postables = this.world.postables; }
}
