...
export class Entity{
	...
	public getComponent<T extends keyof ComponentMapInstances>(componentId: T | string): ComponentMapInstances[T] | undefined{ return this._components.get(componentId) as any; }
	public getComponents(){ return [...this._components.values()]; }
	public hasComponent<T extends string>(componentId: T){return this._components.has(componentId);}
