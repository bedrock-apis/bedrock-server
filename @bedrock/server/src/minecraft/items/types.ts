...
export abstract class ItemType extends Type{
	...
	public readonly abstract componentBased: boolean;
    public readonly abstract typeId: string;
...
export class ItemTypes extends Types<ItemType>{
	...
	public static getByRuntimeId(runtimeId: number){return this.RTYPES.get(runtimeId);}
}

export class InternalItemType extends ItemType{
	public readonly componentBased: boolean;
	public get typeId(){return this.id;}
