import { Byte, Condition, PacketId, PacketIds, ProtocolPacket, SerializeAs, VarInt, VarLong, Vector3, Vector3f } from "@bedrock/base";
...
export class InteractPacket extends ProtocolPacket {
    ...
    @SerializeAs(Vector3f) @Condition(t=>t.actionId === InteractActions.MouseOverEntity || t.actionId === InteractActions.LeaveVehicle) public position?: Vector3;
}
