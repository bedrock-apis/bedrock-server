import { AsList, Byte, Condition, Endianness, PacketId, PacketIds, ProtocolPacket, SByte, SerializeAs, UInt16, UInt32, VarInt, VarLong, Vector3, Vector3f, ZigZag, ZigZong } from "@bedrock/base";
import type { ItemLegacyLike , Vector2Chunk } from "../types/index.js";
import { ItemEntries , InteractActions, BlockCoordinates, WindowsIds , WindowsTypes, ChunkCoordinates  } from "../types/index.js";
